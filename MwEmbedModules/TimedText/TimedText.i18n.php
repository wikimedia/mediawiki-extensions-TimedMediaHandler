...
$messages['ja'] = array(
	...
	'mwe-timedtext-upload-text-success' => '字幕をアップロードしました',
...
$messages['ko'] = array(
	...
	'mwe-timedtext-upload-text' => '텍스트 파일 올리기',
	'mwe-timedtext-uploading-text' => '텍스트 파일 올리는 중',
	'mwe-timedtext-upload-text-desc-title' => '텍스트 파일 올리기',
	'mwe-timedtext-upload-text-desc-help' => '올릴 텍스트 파일 인터페이스는 .srt 파일을 허용합니다',
	'mwe-timedtext-upload-text-desc-help-browse' => '로컬 컴퓨터에서 올릴 .srt 파일 찾아보기',
	'mwe-timedtext-upload-text-desc-help-select' => '파일의 언어 선택',
	'mwe-timedtext-upload-text-desc-help-review' => '텍스트 내용을 검토 / 편집하고 나서 올리기를 눌러 텍스트를 추가하세요',
	'mwe-timedtext-upload-text-preview' => '텍스트 검토',
	'mwe-timedtext-upload-text-success' => '자막 올리기를 성공했습니다',
	'mwe-timedtext-upload-text-done' => '올리기 완료',
	'mwe-timedtext-upload-text-fail-desc' => '올리기를 실패했습니다',
	'mwe-timedtext-upload-text-fail-title' => '올리기 실패',
	'mwe-timedtext-upload-text-another' => '다른 파일 올리기',
	'mwe-timedtext-upload-text-done-uploading' => '올리기 완료',
...
$messages['ro'] = array(
	...
	'mwe-timedtext-upload-text' => 'Încarcă un fișier text',
	'mwe-timedtext-uploading-text' => 'Se încarcă fișierul text',
	'mwe-timedtext-upload-text-desc-title' => 'Încărcare fișier text',
	'mwe-timedtext-upload-text-desc-help' => 'Interfața de încărcare a fișierelor text acceptă fișiere .srt',
	'mwe-timedtext-upload-text-desc-help-browse' => 'Răsfoiți-vă calculatorul pentru a găsi fișierul .srt destinat încărcării',
	'mwe-timedtext-upload-text-desc-help-select' => 'Selectați limba fișierului',
	'mwe-timedtext-upload-text-desc-help-review' => 'Revizuiți/modificați conținutul, iar apoi apăsați butonul de încărcare pentru a adăuga textul',
	'mwe-timedtext-upload-text-preview' => 'Revizuiește textul',
	'mwe-timedtext-upload-text-success' => 'Încărcarea subtitrării sincronizate s-a efectuat cu succes',
...
$messages['sv'] = array(
	...
	'mwe-timedtext-upload-text-success' => 'Uppladdning av tidsbestämda texten var framgångsrik',
...
$messages['uk'] = array(
	...
	'mwe-timedtext-upload-text-desc-help-browse' => "Вкажіть на вашому комп'ютері файл .srt, який Ви хочете завантажити",
	'mwe-timedtext-upload-text-desc-help-select' => 'Оберіть мову файлу',
	'mwe-timedtext-upload-text-desc-help-review' => 'Перевірте / відредагуйте текст і натисніть «Завантажити», щоб додати текст',
	'mwe-timedtext-upload-text-preview' => 'Перевірити текст',
	'mwe-timedtext-upload-text-success' => 'Завантаження синхронізованого тексту',
	'mwe-timedtext-upload-text-done' => 'Завантаження завершено',
	'mwe-timedtext-upload-text-fail-desc' => 'Завантаження не вдалось',
	'mwe-timedtext-upload-text-fail-title' => 'Помилка завантаження',
	'mwe-timedtext-upload-text-another' => 'Завантажити інший',
	'mwe-timedtext-upload-text-done-uploading' => 'Завантаження завершено',
	'mwe-timedtext-back-btn' => 'Назад',
...
$messages['vi'] = array(
	...
	'mwe-timedtext-upload-text-desc-help' => 'Giao diện tải lên tập tin văn bản chấp nhận các tập tin .srt',
	'mwe-timedtext-upload-text-desc-help-browse' => 'Duyệt máy bạn cho tập tin .srt để tải lên',
...
$messages['zh-hans'] = array(
	...
	'mwe-timedtext-upload-text-desc-title' => '上传一个文本文件',
	...
	'mwe-timedtext-upload-text-another' => '上传其他',
