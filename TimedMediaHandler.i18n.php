...
$messages['diq'] = array(
	...
	'timedmedia-days' => '{{PLURAL:$1|1 roce|$1 rocan}}',
	'timedmedia-hours' => '{{PLURAL:$1|1 seata|$1 seatan}}',
	'timedmedia-minutes' => '{{PLURAL: $1|1 deqe|$1 deqey}}',
	'timedmedia-seconds' => '{{PLURAL:$1|1 saniye|$1 saniyeyan}}',
...
Posnetek lahko <a href="$1">snamete</a> ali <a href="http://www.mediawiki.org/wiki/Extension:TimedMediaHandler/Client_download">prenesete predvajalnik</a> za predvajanje posnetka v svojem brskalniku.',
	...
	'timedmedia-subtitle-new-desc' => "Besedo '''LANG''' zamenjajte s [[:en:ISO 639|kodo jezika]] in pritisnite gumb '''{{int:Timedmedia-subtitle-new-go}}'''.",
...
Bạn có chắc chắn muốn tiếp tục?',
	...
	'timedmedia-subtitle-new-desc' => "Thay phần '''LANG''' với [[:vi:ISO 639|mã ngôn ngữ]] của bạn và bấm nút '''{{int:Timedmedia-subtitle-new-go}}'''",
...
您确实想继续吗？',
	...
	'timedmedia-subtitle-new-desc' => "将'''LANG'''替换为您的[[:zh:ISO 639|语言代码]]并按下'''{{int:Timedmedia-subtitle-new-go}}'''按钮",
...
您確實想繼續嗎？',
	...
	'timedmedia-subtitle-new-desc' => "將'''LANG'''替換為您的[[:en:ISO 639|語言代碼]]並按下'''{{int:Timedmedia-subtitle-new-go}}'''按鈕",
	'timedmedia-subtitle-new-go' => '提交',
	'timedmedia-subtitle-language' => '$1（$2）字幕',
