...
Du kannst <a href="$1">den Clip herunterladen</a> oder <a href="//www.mediawiki.org/wiki/Extension:TimedMediaHandler/Client_download">eine Abspielsoftware herunterladen</a>, um den Clip im Browser abzuspielen.',
	...
	'timedmedia-subtitle-new-desc' => "Ersetze '''$1''' durch deinen [[:de:ISO 639|Sprachcode]] und klicke auf '''{{int:Timedmedia-subtitle-new-go}}'''",
...
Êtes-vous sûr de vouloir continuer ?',
	...
	'timedmedia-subtitle-new-desc' => "Remplacer l'expression '''LANG ''' par votre [[:en:ISO 639|code de langue]] utilisée et appuyez sur le bouton '''{{int:Timedmedia-subtitle-new-go}}'''.",
...
Está seguro de querer continuar?',
	...
	'timedmedia-subtitle-new-desc' => "Substitúa o texto '''\$1''' co [[:en:ISO 639|código da súa lingua]] e prema no botón \"'''{{int:Timedmedia-subtitle-new-go}}'''\"",
...
אתם יכולים <a href="$1">להוריד למחשב את הסרטון</a> או <a href="//www.mediawiki.org/wiki/Extension:TimedMediaHandler/Client_download">להוריד למחשב שלכם נגן</a> שינגן את הסרטון בדפדפן שלכם.',
	...
	'timedmedia-subtitle-new-desc' => "יש להחליף את '''$1''' בקוד [[:he:ISO 639|קוד השפה]] וללחוץ על כפתור '''{{int:Timedmedia-subtitle-new-go}}'''",
...
Continuare?',
	...
	'timedmedia-subtitle-new-desc' => "Sostituire la parte '''$1''' con il proprio [[:en:ISO 639|codice linguistico]] e premere il pulsante '''{{int:Timedmedia-subtitle-new-go}}'''",
...
再生するには、<a href="$1">クリップをダウンロード</a>するか、<a href="//www.mediawiki.org/wiki/Extension:TimedMediaHandler/Client_download">プレーヤーをダウンロード</a>する必要があります。',
	...
	'timedmedia-source-file-desc' => 'オリジナル $1、$2 × $3 ($4)',
	...
	'timedmedia-subtitle-new-desc' => "'''$1''' 部分を自分の[[:en:ISO 639|言語コード]]に置換して、'''{{int:Timedmedia-subtitle-new-go}}'''ボタンを押してください。",
...
계속하겠습니까?',
	...
	'timedmedia-subtitle-new-desc' => "[[:en:ISO 639|언어 코드]]로 '''$1''' 부분을 바꾸고 나서 '''{{int:Timedmedia-subtitle-new-go}}''' 버튼을 누르세요",
	...
	'timedmedia-videos' => '동영상 $1개',
	'timedmedia-ogg-videos' => 'Ogg 동영상 $1개',
	'timedmedia-webm-videos' => 'WebM 동영상 $1개',
	'timedmedia-derivative-state-transcodes' => '코드 변환 $1개',
	'timedmedia-derivative-state-active' => '실행 중인 코드 변환 $1개',
...
Anda boleh <a href="$1">memuat turun sedutan</a> itu atau <a href="//www.mediawiki.org/wiki/Extension:TimedMediaHandler/Client_download">memuat turun pemain</a> yang boleh memutarkan sedutan berkenaan dalam pelayar anda.',
	...
	'timedmedia-subtitle-new-desc' => "Ganti bahagian '''$1''' dengan [[:ms:ISO 639|kod bahasa]] anda, kemudian tekan butang '''{{int:Timedmedia-subtitle-new-go}}'''",
...
ଆପଣ ଏହି ଭିଡ଼ିଓଟିକୁ ଆପଣଙ୍କ ବ୍ରାଉଜରରେ ଚଲାଇବା ପାଇଁ<a href="$1">ଭିଡିଓ କ୍ଲିପଟିକୁ ଡାଉନଲୋଡ କରିପାରିବେ</a> କିମ୍ବା <a href="//www.mediawiki.org/wiki/Extension:TimedMediaHandler/Client_download">ଭିଡ଼ିଓ ପ୍ଲେୟାର ମଧ୍ୟ ଡାଉନଲୋଡ କରିପାରିବେ</a> ।',
	...
	'timedmedia-error-on' => '$1 ଟ୍ରାନ୍ସକୋଡରେ ଅସୁବିଧା ।',
	...
	'timedmedia-show-error' => 'ଅସୁବିଧା ଦେଖାଇବେ',
...
ଆପଣ ପ୍ରକ୍ରିୟାକୁ ଚାଲୁରଖିବା ପାଇଁ ନିଶ୍ଚିତ ?',
	...
	'timedmedia-source-file-desc' => 'ମୂଳ $1, $2 × $3 ($4)',
	...
	'timedmedia-subtitle-new-desc' => "ଆପଣଙ୍କ [[:en:ISO 639|ଭାଷା କୋଡକୁ]] '''$1'''ଜାଗାରେ ବଦଳାନ୍ତୁ ଏବଂ {{int:Timedmedia-subtitle-new-go}}'''ବଟନ ଦବାନ୍ତୁ",
	...
	'timedmediahandler' => 'ସମୟମେଡିଆ ପରିଚାଳକ',
...
A peul <a href="$1">dëscarié la senëtta</a> o <a href="//www.mediawiki.org/wiki/Extension:TimedMediaHandler/Client_download">dëscarié un riprodutor</a> për visualisé la senëtta su sò navigador.',
	...
	'timedmedia-status-header' => 'Stat trascodìfica',
	'timedmedia-update-status' => 'Agiorna stat trascodìfica',
	'timedmedia-status' => 'Stat',
	'timedmedia-status-unknown' => 'Stat pa conossù',
	'timedmedia-transcodeinfo' => 'Descrission derivà ëd trascodìfica',
	'timedmedia-actions' => 'Assion',
	'timedmedia-direct-link' => 'Dëscaria derivà',
	'timedmedia-not-ready' => 'Pa pront',
	'timedmedia-completed-on' => 'Trascodìfica completà $1',
	'timedmedia-error-on' => 'Eror an trascodìfica dzor $1.',
	...
	'timedmedia-unknown-target-size' => 'Dimension destinassion pa conossùa, $1 codificà',
	...
	'timedmedia-show-error' => 'Smon eror',
	'timedmedia-reset' => 'Torna amposté trascodìfica',
	'timedmedia-reset-confirm' => 'Torna amposté sta trascodìfica a tramuderà minca archivi esistent (se present) e a gionterà torna la trascodìfica a la coa dij travaj. A pijerà quaich temp a torna trascodifiché. <br /><br />
It ses-to sigur ëd vorèj continué?',
	'timedmedia-reset-error' => 'Eror an torna ampostand ël travaj ëd trascodìfica.',
	'timedmedia-mp4' => 'MP4',
	...
	'timedmedia-subtitle-new' => 'Crea tradussion neuva e modìfica esistent',
	'timedmedia-subtitle-new-desc' => "Rimpiassa la part '''$1''' con tò [[:en:ISO 639|còdes ëd lenga]] e sgnaca ël boton '''{{int:Timedmedia-subtitle-new-go}}'''",
	'timedmedia-subtitle-new-go' => 'Va',
	...
	'timedmedia-subtitle-no-subtitles' => 'A-i é al moment gnun sot-tìtoj an $1 për sto filmà, it peule [{{fullurl:{{FULLPAGENAME}}|action=edit}} modifiché sta pagina] për giontelo',
	'timedmedia-subtitle-remote' => 'Ij sot-tìtoj për sto archivi a son ospità dzor $1',
	'timedmedia-subtitle-remote-link' => 'It peule [$1 vëdde la pagina ëd descrission] për sto file dzor $2',
	'timedmediahandler' => 'TimedMediaHandler',
	...
	'right-transcode-reset' => 'Torna amposté ij filmà falì o trascodificà parèj a son anserì torna ant la coa dij travaj.',
	'right-transcode-status' => "Varda [[Special:TimedMediaHandler|anformassion a propòsit ëd l'atività corenta ëd trascodìfica]]",
...
Posnetek lahko <a href="$1">snamete</a> ali <a href="//www.mediawiki.org/wiki/Extension:TimedMediaHandler/Client_download">prenesete predvajalnik</a> za predvajanje posnetka v svojem brskalniku.',
	...
	'timedmedia-subtitle-new-desc' => "Besedo '''$1''' zamenjajte s [[:en:ISO 639|kodo jezika]] in pritisnite gumb '''{{int:Timedmedia-subtitle-new-go}}'''.",
...
Bạn có chắc chắn muốn tiếp tục?',
	...
	'timedmedia-subtitle-new-desc' => "Thay phần '''$1''' với [[:vi:ISO 639|mã ngôn ngữ]] của bạn và bấm nút '''{{int:Timedmedia-subtitle-new-go}}'''",
